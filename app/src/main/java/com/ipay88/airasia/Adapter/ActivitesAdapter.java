...
public class ActivitesAdapter extends RecyclerView.Adapter<ActivitesAdapter.MyViewHolder>  {
    ...
    public ActivitesAdapter(Activity activity, List<BestDealModel> basicValueModelList) {
