...
public class RecentSearchAdapter extends RecyclerView.Adapter<RecentSearchAdapter.MyViewHolder>  {
    ...
    private  List<RecentSearchModel> basicValueModelList;
    ...
    public RecentSearchAdapter(Activity activity, List<RecentSearchModel> basicValueModelList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recentsearch_layout, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final RecentSearchModel basicValueModel = basicValueModelList.get(position);
